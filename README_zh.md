...
### 增量算法加速比（Rust，+0.1% 顶点数的新边）

| 算法 | 5万随机图 | soc-Epinions1 (7.5万) | web-Google (91.6万) | RMAT21 (210万) |
|------|:---:|:---:|:---:|:---:|
| BFS | **1580x** (+50) | **4690x** (+76) | **131x** (+916) | **8467x** (+2097) |
| 连通分量 | **4920x** (+50) | **569x** (+76) | **721x** (+916) | **720x** (+2097) |
| PageRank | **18.9x** (+50) | **10.3x** (+76) | **9.9x** (+916) | **9.8x** (+2097) |

> PageRank 稳定在 ~10x（100→10 次迭代）。BFS 加速比随扰动量增长。详见[综合基准测试](core-research/performance-tests/LARGE_SCALE.md)。

### vs petgraph（Rust 库对比）

| 规模 | EdgeBlock PageRank | petgraph PageRank | EB 优势 |
|:---:|:---:|:---:|:---:|
| 7.5万 | 49ms | 213ms | 4.3x |
| 10万 | 63ms | 98ms | 1.6x |
| 42.5万 | 319ms | 604ms | 1.9x |
| 91.6万 | 938ms | 9022ms | 9.6x |
| 210万 | 1401ms | 66543ms | **47.5x** |

> CSR PageRank 优势随规模线性放大。详细库对比：[基准测试报告](core-research/performance-tests/LARGE_SCALE.md)。
