...
Axolotl（墨西哥钝口螈）是一种具有非凡再生能力的两栖动物 —— 它可以再生完整的四肢、脊髓、甚至部分大脑而不会留下疤痕。
...
|---------------|-----------|
| 再生四肢 | 增量更新（只更新受影响的部分） |
| 适应环境 | CPU+GPU 动态适应工作负载 |
| 弹性愈合 | 优雅处理动态图变化 |
| 幼态持续（保持幼虫形态） | 原型阶段的研究，持续进化 |

正如 axolotl 代表了生物学上的再生创新，本项目探索计算上的"再生" —— 当图发生变化时，高效地更新图计算结果。
