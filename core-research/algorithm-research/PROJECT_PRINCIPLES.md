...
> 
> 本文档记录早期设计思路和 Swift 原型目标。自 v0.1.0-beta（2026-07-07）发布以来：
> - 5 种增量算法已全部以 Rust 实现并实测（BFS 1580x, CC 4920x, PR 18.9x）
> - 文中性能目标（244x/80x/74x 等）来自 Swift 原型，不可与 Rust 实测直接比较
> - 请以根目录 [README.md](../../README.md) 和技术报告为当前权威参考
